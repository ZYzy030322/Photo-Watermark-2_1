...
### 主要类说明
- [MainFrame](PhotoWatermark2/src/main/java/org/example/MainFrame.java)：主窗口类，负责UI展示和事件处理
- [SwingMainApp](PhotoWatermark2/src/main/java/org/example/SwingMainApp.java)：应用程序入口点
- [WatermarkConfig](PhotoWatermark2/src/main/java/org/example/model/WatermarkConfig.java)：水印配置模型类
- [ImageData](PhotoWatermark2/src/main/java/org/example/model/ImageData.java)：图片数据模型类
- [WatermarkService](PhotoWatermark2/src/main/java/org/example/service/WatermarkService.java)：水印处理服务类
- [PreviewService](PhotoWatermark2/src/main/java/org/example/service/PreviewService.java)：预览服务类
- [TemplateService](PhotoWatermark2/src/main/java/org/example/service/TemplateService.java)：模板管理服务类
